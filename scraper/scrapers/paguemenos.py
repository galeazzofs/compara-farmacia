...
class PagueMenosScraper(BaseScraper):
    ...
    async def search(self, remedio: str, cep: str) -> Optional[dict]:
        url = "https://www.paguemenos.com.br/api/io/_v/api/intelligent-search/product_search/trade-policy/1"
        ...
        url_produto = f"https://www.paguemenos.com.br{link}" if link else url
